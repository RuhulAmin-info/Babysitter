...
$id = $_GET['id'];
	...
	$sql = "SELECT * FROM post WHERE id = '$id'";
 	...
 	$present_balance = $p_payment + $payment;
 	
 	$present_spend = $p_spend - $payment;
 	$sql2 = "UPDATE account SET total_spend='$present_spend',current_balance = '$present_balance' WHERE username = '$username'";
